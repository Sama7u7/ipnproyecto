...
class DeshidratadoController extends Controller
{
    public function __construct()
    {
        Route::post("/deshidratadores/deshidratado/data", [self::class, 'receiveData'])
            ->name("deshidratadores.deshidratado.data");
    }
    ...
    public function receiveData(Request $request)
    {
        ...
        DB::table("deshidratado_dht1")->insert([
        ...
        DB::table("deshidratado_dht2")->insert([
        ...
        DB::table("deshidratado_dht3")->insert([
        ...
        DB::table("deshidratado_peso")->insert([
